...
ECHO Configuring...
CALL cmake -H. -Bbuild -G"%CMAKE_GENERATOR%" -T"%CMAKE_TOOLSET%" -DWEBRTC_ROOT_DIR=".cache\webrtc" -DDepsPath=".cache\obs_deps\%OBS_DEPENDENCIES_ARCH%" -DCMAKE_INSTALL_PREFIX=".install"
