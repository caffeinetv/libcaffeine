...
typedef enum caff_LogLevel {
    ...
    caff_LogLevelEnd  /* Bounds check. Do not use. */
} caff_LogLevel;
...
typedef enum caff_VideoFormat {
    ...
    caff_VideoFormatEnd  /* Bounds check. Do not use. */
} caff_VideoFormat;
...
typedef enum caff_Error {
    ...
    caff_ErrorEnd  /* Bounds check. Do not use. */
} caff_Error;
...
typedef enum caff_Rating {
    ...
    caff_RatingEnd  /* Bounds check. Do not use. */
} caff_Rating;
