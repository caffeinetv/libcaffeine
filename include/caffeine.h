...
typedef struct caff_Credentials * caff_CredentialsHandle;

struct caff_Stream;
typedef struct caff_Stream* caff_StreamHandle;

/* Result of sign-in attempt */
typedef struct caff_AuthResponse {
    caff_CredentialsHandle credentials;
    char * next;
    char * mfaOtpMethod;
} caff_AuthResponse;
...
CAFFEINE_API void caff_freeCredentials(caff_CredentialsHandle * creds);
...
CAFFEINE_API char const * caff_getRefreshToken(caff_CredentialsHandle creds);
CAFFEINE_API caff_UserInfo * caff_getUserInfo(caff_CredentialsHandle creds);
