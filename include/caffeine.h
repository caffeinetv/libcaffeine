...
typedef enum caff_LogLevel {
    ...
    caff_LogLevel_Error,
    caff_LogLevel_None,
    caff_LogLevel_Last = caff_LogLevel_None
} caff_LogLevel;
...
typedef enum caff_VideoFormat {
    ...
    caff_VideoFormat_Last = caff_VideoFormat_Bgra
} caff_VideoFormat;
...
typedef enum caff_Error {
    ...
    caff_Error_Unknown,
    caff_Error_Last = caff_VideoFormat_Unknown
} caff_Error;
...
typedef enum caff_Rating {
    ...
    caff_Rating_Last = caff_Rating_SeventeenPlus
} caff_Rating;
