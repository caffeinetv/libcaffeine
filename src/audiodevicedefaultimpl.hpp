...
namespace caff {
    ...
    class AudioDeviceDefaultImpl : public rtc::RefCountedObject<webrtc::AudioDeviceModule> {
    public:
        ...
        virtual int32_t RegisterAudioCallback(webrtc::AudioTransport* audioCallback) override = 0;
        ...
        virtual int32_t PlayoutIsAvailable(bool* available) override { *available = false; return 0; }
        virtual int32_t InitPlayout() override { return -1; }
        virtual bool PlayoutIsInitialized() const override { return false; }
        virtual int32_t RecordingIsAvailable(bool* available) override { *available = true; return 0; }
        ...
        virtual int32_t SpeakerVolumeIsAvailable(bool* available) override { *available = false; return 0; }
        ...
        virtual int32_t MicrophoneVolumeIsAvailable(bool* available) override { *available = false; return 0; }
        ...
        virtual int32_t SpeakerMuteIsAvailable(bool* available) override { *available = false; return 0; }
        ...
        virtual int32_t MicrophoneMuteIsAvailable(bool* available) override { *available = false; return 0; }
        ...
        // Stereo support
        virtual int32_t StereoPlayoutIsAvailable(bool* available) const override { *available = false; return 0; }
        ...
        virtual int32_t StereoRecordingIsAvailable(bool* available) const override { *available = true; return 0; }
